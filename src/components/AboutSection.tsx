		...
		<section id={sectionId} className="bg-dark-green section-padding">
			<div className="container">
				<div className="max-w-2xl space-y-8">
					<p className="font-niramit text-2xl lg:text-3xl text-primary-green leading-relaxed">
					...
					<p className="font-poppins text-lg lg:text-xl text-white leading-relaxed">
